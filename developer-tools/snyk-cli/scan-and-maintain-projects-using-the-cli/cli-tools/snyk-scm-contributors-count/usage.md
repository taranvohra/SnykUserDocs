...
**`<command-options>`**: see SCM-specific pages (example pages) in the [scripts](/broken/pages/rKXF0VenSkqobqGMJIBX) section.
...
Used for consolidating results from several commands across different SCMs, into a single file with unique contributors count. Refer to the [command page](/broken/pages/bSIcUSDGX1HU05ikukZj).
