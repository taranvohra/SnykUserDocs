...
To test Java projects using their package manager manifest files, see [Options for Maven projects](/broken/pages/5B8Rkpqdn0RNAgHDZFYy#options-for-maven-projects) and [Options for Gradle projects](/broken/pages/5B8Rkpqdn0RNAgHDZFYy#options-for-gradle-projects) in the CLI `test` command help.

To learn more about the `snyk test --scan-all-unmanaged`, see the [Maven options section of the CLI reference](/broken/pages/dcmeFYQMxrHs1ZSVFEe2#option-for-maven-projects).
...
1. Install the latest version of the Snyk CLI - see [Install the Snyk CLI](/broken/pages/1Ld4PeRTHIkACdPLh74L).
