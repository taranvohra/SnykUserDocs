...
Note: The `--severity-threshold` option is available with the `snyk test`, `snyk code`, `snyk container`, and `snyk iac test` commands. See the [CLI commands help](/broken/pages/hVyNTA766cyArIzfUDeu) pages for each command for details.
