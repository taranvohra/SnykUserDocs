...
[Paid services](../../../more-info/snyk-terms-of-support-and-services-glossary.md) can be engaged to assist in Snyk Broker deployments.
{% endhint %}
...
* Full control over testing: which tests to run and where in the builld script
