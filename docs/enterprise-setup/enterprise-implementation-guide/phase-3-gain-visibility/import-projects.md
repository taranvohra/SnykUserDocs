...
{% hint style="info" %}
See the [Getting started](../../../getting-started/) section and [Start scanning using the CLI, Web UI, or AP](../../../scan-applications/start-scanning-using-the-cli-web-ui-or-api/) for more details.
{% endhint %}
