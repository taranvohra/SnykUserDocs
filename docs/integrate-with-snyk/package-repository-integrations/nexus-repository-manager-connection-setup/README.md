...
{% hint style="info" %}
**Supported Projects**\
The Nexus Repository Manager integration currently supports [Node.js](../../../scan-applications/supported-languages-and-frameworks/javascript.md#supported-frameworks-and-package-managers) (npm and Yarn) and [Maven](broken-reference/) projects. Gradle projects are not currently supported.
{% endhint %}
