...
See [Understanding the Priority Score of the Snyk Code issues](../snyk-code/exploring-and-working-with-snyk-code-results-in-the-web-ui/exploring-the-code-analysis-page/understanding-the-priority-score-of-snyk-code-issues.md) for details.
