...
* **Ignores**: Define Organization-wide ignore settings. You can choose from the following options:
  ...
  * **Require reason for each ignore**
    ...
    * `Not required`
    * See [Configure Ignore settings](../../scan-using-snyk/find-and-manage-priority-issues/ignore-issues.md#configure-ignore-settings) in the Ignore issues documentation for more details.
