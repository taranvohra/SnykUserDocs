...
{% hint style="info" %}
If you have been using Snyk on the Free or Team Plan and are looking for guidance on upgrading to the Enterprise plan, see [Upgrading to the Enterprise Plan](https://github.com/taranvohra/SnykDocs/blob/main/docs/enterprise-setup/broken-reference/README.md).
{% endhint %}
...
{% hint style="info" %}
The tool that best serves your tech stack, environment, and workflow depends on your individual circumstances. Visit the [guide](https://github.com/taranvohra/SnykDocs/blob/main/docs/enterprise-setup/broken-reference/README.md) specific to your language for more details.
{% endhint %}
...
See [Preparing for implementation of the Enterprise plan](https://github.com/taranvohra/SnykDocs/blob/main/docs/enterprise-setup/broken-reference/README.md) for more information on configuring the Git repository integration for your Organization.
...
* When you are ready to plan a Snyk rollout to more teams, review [Preparing for implementation of the Enterprise plan](https://github.com/taranvohra/SnykDocs/blob/main/docs/enterprise-setup/broken-reference/README.md) for more information.
