...
The [Automatic PR Checks feature](https://github.com/taranvohra/SnykDocs/blob/main/docs/snyk-admin/snyk-broker/snyk-broker-code-agent/broken-reference/README.md) is currently not supported in the Snyk Broker - Code Agent deployment method.
