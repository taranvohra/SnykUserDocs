...
{% hint style="info" %}
See the [Getting started](../../../discover-snyk/getting-started/) section and [Start scanning](../../../scan-with-snyk/start-scanning.md) for more details.
{% endhint %}
...
You can connect your repositories for automatic scanning. See [Snyk SCM integrations](../../../developer-tools/scm-integrations/organization-level-integrations/) for more details.
...
The [Snyk CLI](../../../developer-tools/snyk-cli/) allows granular scanning of individual Projects.
...
You can scan using the [Snyk API](../../../snyk-api/snyk-api.md). This enables large-scale automated scanning.
