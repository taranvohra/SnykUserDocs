...
3.  Navigate to Azure and open Entra ID.
    ...
    <figure><img src="../../../../.gitbook/assets/3 (4) (1).png" alt="Entra ID Default Directory"><figcaption><p>Entra ID Default Directory</p></figcaption></figure>
...
11. Scroll to find the login URL needed to finish the configuration in Snyk. Copy it and paste it into the SSO settings in the Snyk portal.
    ...
    <figure><img src="../../../../.gitbook/assets/1 (3).png" alt="Sign in URL in Snyk portal"><figcaption><p>Sign in URL in Snyk portal</p></figcaption></figure>
