...
{% file src="../../../.gitbook/assets/SSO Azure Worksheet (3) (1).pdf" %}

{% file src="../../../.gitbook/assets/SSO SAML Worksheet (1) (1).pdf" %}

{% file src="../../../.gitbook/assets/SSO ADFS Worksheet (1) (1).pdf" %}
