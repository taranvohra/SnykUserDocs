...
For more information, see [Automated pull request creation for new fixes](../../scan-using-snyk/snyk-open-source/open-source-basics/fix-pull-requests-for-new-vulnerabilities.md).
{% endhint %}
...
1. In Snyk, go to <img src="../../.gitbook/assets/cog_icon.png" alt="Settings" data-size="line"> (Organization settings) > **Integrations > Source control > Bitbucket Cloud App**, and click **Edit Settings**.
2. Scroll to **Default Snyk test for pull requests > Open Source Security & Licenses**, and configure the relevant options. See [Configure PR Checks](../../scan-using-snyk/run-pr-checks/configure-pr-checks.md) for more details.
...
{% hint style="warning" %}
The first-party interface currently supports only the [Snyk Open Source](../../scan-using-snyk/snyk-open-source/) and [Snyk Container](../../scan-using-snyk/snyk-container/) products. Issues from other Snyk products do not show up on this page.
{% endhint %}
