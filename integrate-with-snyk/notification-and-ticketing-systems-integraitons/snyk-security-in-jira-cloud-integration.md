...
3. [Log in to your Snyk account](https://github.com/taranvohra/SnykDocs/blob/main/docs/integrate-with-snyk/notification-and-ticketing-systems-integraitons/broken-reference/README.md), or [sign up for a new Snyk account](../../getting-started/quickstart/create-or-log-in-to-a-snyk-account.md).
