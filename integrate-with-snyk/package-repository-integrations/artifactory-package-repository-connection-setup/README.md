...
{% hint style="info" %}
**Supported Projects**\
The Artifactory Package Repository integration currently supports [Node.js](../../../scan-using-snyk/supported-languages-and-frameworks/javascript/#supported-frameworks-and-package-managers) (npm and Yarn) and [Maven](https://github.com/taranvohra/SnykDocs/blob/main/docs/integrate-with-snyk/package-repository-integrations/artifactory-package-repository-connection-setup/broken-reference/README.md) Projects. Gradle Projects are not currently supported.
{% endhint %}
