...
PR Checks also support all programming languages and frameworks supported by the Snyk Code and Open Source engines. For more information, see programming language support for [Snyk Code](https://github.com/taranvohra/SnykDocs/blob/main/docs/scan-using-snyk/run-pr-checks/broken-reference/README.md) and [Open Source](https://github.com/taranvohra/SnykDocs/blob/main/docs/scan-using-snyk/run-pr-checks/broken-reference/README.md).
