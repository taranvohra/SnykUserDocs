...
You can use Snyk IaC (Infrastructure as Code) in the [Snyk Web UI](https://github.com/taranvohra/SnykDocs/blob/main/docs/scan-infrastructure/getting-started-with-current-iac/broken-reference/README.md) to find, view, and fix issues in configuration files. You can also use Snyk IaC in the Snyk CLI. For details, see [Snyk CLI for Infrastructure as Code](../../snyk-cli/scan-and-maintain-projects-using-the-cli/snyk-cli-for-iac/).
