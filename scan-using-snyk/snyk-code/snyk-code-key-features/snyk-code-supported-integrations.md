# Snyk Code supported integrations

Snyk supports the integrations identified on this page.

{% hint style="info" %}
Snyk Code supports a wide range of languages. For details see [Snyk Code - Supported languages and frameworks](https://github.com/taranvohra/SnykDocs/blob/main/docs/scan-using-snyk/snyk-code/snyk-code-key-features/broken-reference/README.md).
{% endhint %}
