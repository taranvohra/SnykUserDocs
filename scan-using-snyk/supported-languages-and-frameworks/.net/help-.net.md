...
For framework support, see [Snyk Code - Supported languages and frameworks](https://github.com/taranvohra/SnykDocs/blob/main/docs/scan-using-snyk/supported-languages-and-frameworks/.net/broken-reference/README.md).
...
For more information on Paket support, see [Snyk for .net](https://github.com/taranvohra/SnykDocs/blob/main/docs/scan-using-snyk/supported-languages-and-frameworks/.net/broken-reference/README.md).
...
See [Snyk for .NET](https://github.com/taranvohra/SnykDocs/blob/main/docs/scan-using-snyk/supported-languages-and-frameworks/.net/broken-reference/README.md) for more information
...
* [Snyk for .Net](https://github.com/taranvohra/SnykDocs/blob/main/docs/scan-using-snyk/supported-languages-and-frameworks/.net/broken-reference/README.md)
