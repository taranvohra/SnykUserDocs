...
* Framework support - see [Snyk Code - Supported languages and frameworks](https://github.com/taranvohra/SnykDocs/blob/main/docs/scan-using-snyk/supported-languages-and-frameworks/java-and-kotlin/broken-reference/README.md).
