...
{% hint style="info" %}
Code analysis support for Objective-C is in Early Access and is available only with Enterprise plans. To enable the feature, see [Snyk Preview](https://github.com/taranvohra/SnykUserDocs/blob/main/docs/scan-with-snyk/snyk-platform-administration/snyk-preview.md).
{% endhint %}
