...
If you have generated the rules using the `template` command, as shown in [Writing a rule](/broken/pages/2ITQcpNltLbNdY3lvroc), then you can also benefit from using the testing functionality that comes with the SDK and the generated rules.
