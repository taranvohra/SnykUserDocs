...
The Snyk CLI can scan unmanaged JAR files in [Java applications](https://github.com/taranvohra/SnykDocs/blob/main/docs/snyk-cli/test-for-vulnerabilities/broken-reference/README.md) to identify which open-source package they contain.
...
**Prerequisite:** You must install a [supported version](https://github.com/taranvohra/SnykDocs/blob/main/docs/snyk-cli/test-for-vulnerabilities/broken-reference/README.md) of Maven to scan unmanaged JAR files.
