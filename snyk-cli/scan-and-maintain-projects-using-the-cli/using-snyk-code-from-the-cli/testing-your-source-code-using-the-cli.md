...
* Manually creating a `.snyk` file in the tested folder. See [Excluding directories and files from the import process](../../../scan-using-snyk/snyk-code/snyk-code-and-your-repositories/excluding-directories-and-files-from-the-import-process.md).
...
Snyk Code tests the current folder and displays the [test results](https://github.com/taranvohra/SnykDocs/blob/main/docs/snyk-cli/scan-and-maintain-projects-using-the-cli/using-snyk-code-from-the-cli/broken-reference/README.md) in the terminal.
